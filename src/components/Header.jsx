                ...
                <div className='mb-4 flex flex-col gap-4 sm:px-4 '>
                    {/* portada */}
                    {
                        !tienda.portada.color ? (
                            ...
                            <div style={{ backgroundColor: tienda.color }} className={"h-40 sm:rounded-b-lg object-top sm:h-56"}></div>
                        )
                    }
                    {/* info de la tienda */}
                    <div className="flex flex-col items-center gap-2 ">
                        ...
                        <div className="flex flex-col items-center gap-4 text-center">
                            ...
                            <div className="flex gap-2">
                                ...
                                <Information href={tienda.whatsapp} />
...
const SkeletonComponent = () => {
    return (
        <div className='mb-4 flex flex-col gap-4 sm:px-4 '>
            {/* portada */}
            <div className={"h-40 sm:rounded-b-lg animate-pulse bg-gray-200 object-cover object-top sm:h-56"}></div>
            {/* info de la tienda */}
            <div className="flex flex-col items-center gap-2 ">
                <div className="-mt-20 rounded-full opacity-100 bg-gray-200">
                    <div className="h-40 w-40 min-w-[128px] rounded-full border-8 animate-pulse bg-gray-200 border-white"></div>
                </div>
                <div className="flex flex-col items-center justify-center gap-4 text-center">
                    <div className="flex flex-col justify-center items-center gap-4">
                        <div className="h-8 w-40  animate-pulse bg-gray-200 sm:h-5 sm:w-60 rounded-full"></div>
                        <div className="h-6 w-72 sm:w-80 animate-pulse bg-gray-200 rounded-full"></div>
                    </div>
                    <div className="flex gap-2">
                        {/* Iconos header */}
                        <div className={`flex h-10 w-10 items-center justify-center rounded-full animate-pulse bg-gray-200 text-transparent`}>
                ...
                <div className={`w-full  sm:rounded-lg animate-pulse bg-gray-200 h-10 my-4`}></div>
            </div>
        </div>
    )
}
        const WhatsApp = ({ href = "#" }) => {
            ...
            return (<a href={href === "#" ?href:`https://api.whatsapp.com/send/?phone=${href}`} {...(href === "#" ? null : prop)}>
        ...
        const Information = ({ href = "#" }) => {
            const prop = { rel: "noopener noreferrer", target: "_blank" }
            return (<a href={href} {...(href === "#" ? null : prop)}>
                <div style={{ backgroundColor: tienda.color }} className={`flex h-10 w-10 items-center justify-center rounded-full text-white`}>
                <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" height="22" width="22" xmlns="http://www.w3.org/2000/svg"><path fill="none"  strokeWidth="2" d="M12,22 C17.5228475,22 22,17.5228475 22,12 C22,6.4771525 17.5228475,2 12,2 C6.4771525,2 2,6.4771525 2,12 C2,17.5228475 6.4771525,22 12,22 Z M12,10 L12,18 M12,6 L12,8"></path></svg>
                </div>
            </a>
            )
        }
