export const tienda = {
  ...
  portada: {
    color: false,
    imagen:
      "https://meraki-sublimacion-b2a13.web.app/assets/vueltaAClases-e6ae1326.jpg"
  },
  descripcion:
    "Diseño gráfico, estampados, remeras, gorros, banderas, buzos, camperas, subliminado, vinilo textil",
  anuncio: "¡Volvé a clases con los diseños que más te gustan!",
  modo_de_pago: {
    mercadopago: false,
    efectivo: false,
    transferencia: false
...
export const categorias = [
  ...
  {
    nombre: `Sets escolares `,
    productos: [
      {
        titulo: "Ponchito + Set jardín completo",
        detalle:
